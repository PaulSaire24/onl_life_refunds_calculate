...
public class RBVDR402Impl extends RBVDR402Abstract {
	...
	public RefundCalculateResponseBO executeCalculateService(SignatureAWS signatureAWS, String requestJson) {
		...
		try {
			...
			throw new BusinessException(Constans.Error.BBVAE2, false, "Lo sentimos, el servicio de gestionar documento de rimac está tardando más de lo esperado. Por favor,  intentelo nuevamente en unos minutos.");
		}
